@extends('Layouts::app')
@section('title', __('cruds.sprint.title'))
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            <div class="page-title-box">
                <h4 class="page-title">@lang('cruds.sprint.title')</h4>
            </div>
            <div class="my-3">
                <a href="javascript:void(0);"  class="btn btn-primary btnAddSprint">Create</a>
            </div>
        </div>
    </div>
...
@include('Sprint::partials.script')
